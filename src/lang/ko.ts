...
export const languageKorean = {
    ...
    "modelPresetBindingMainUnset": "이 채팅에 바인딩된 메인 모델 프리셋이 없습니다. 전송하려면 바인딩하세요.",
    "modelPresetBindingSubUnset": "이 채팅에 바인딩된 보조 모델 프리셋이 없습니다. 전송하려면 바인딩하세요.",
    "modelPresetBindingTitle": "모델/보조 모델 프리셋 바인딩",
    "useModelPresetBindingToggle": "모델 프리셋 바인딩 사용하기",
    "modelPresetConfigure": "모델 프리셋 설정하기",
    "modelPresetSetDefaultConfirm": "현재 모델 바인딩을 새 채팅 기본값으로 지정할까요?",
